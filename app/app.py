...
# Streamlit App
# ------------------------
st.set_page_config(page_title="Custom Tokenizer", page_icon="📝", layout="wide")
...
if uploaded_file is not None:
    ...
    with col1:
        ...
        with st.expander("📑 Vocabulary (full)"):
            st.dataframe(list(vocab.items()), use_container_width=True, height=400)

    with col2:
        st.subheader("🔡 Tokenized Data")
        st.write(preprocessed[:50])  # preview first 50 tokens
